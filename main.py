...
def main(ticket_texts: List[str], use_real_api: bool = True, export_results: bool = False, output_format: str = "detailed"):
    ...
    print_results(classified_tickets, crm_results, output_format)
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--simple",
        action="store_true",
        help="Use simple output format matching Problem Statement example"
    )
    parser.add_argument(
        "--tickets",
        nargs="+",
    ...
    output_format = "simple" if args.simple else config.OUTPUT_FORMAT
